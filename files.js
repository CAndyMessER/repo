...
function esercizio()
let min=InserisciNumero("inserisci valore min",0, Infinity)
let max=InserisciNumero("inserisci valore max",0, Infinity)
let n=InserisciNumero("inserisci valore n",0, Infinity)

let p=0
let q=0
let med=0
while(min>max){
 	min=InserisciNumero("inserisci valore min",0, Infinity)
 	max=InserisciNumero("inserisci valore max",0, Infinity)
}
if (min<max) {
	let list=[]
	for ( i = 0; i < n; i++) {
